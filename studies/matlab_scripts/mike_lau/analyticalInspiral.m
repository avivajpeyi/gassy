classdef analyticalInspiral < handle
    ...
    properties
        ...
        ROTFACTOR         % Rotation of donor as a function of Keplerian angular velocity at surface (this decreases drag)
        ...
        vKep              % Keplerian velocity, (GM/a)^1/2
        dlogP_dlogrho
    ...
    methods
        ...
        function obj = analyticalInspiral(dt,endsep,xFactor,rotFactor,donorProfile,macc)
            ...
            % Initialise arrays
            npts = obj.MAXSTEPNO; % Choose a large number as array length
            [obj.time,...
             obj.dt,...
             obj.totene,...
             obj.dragCoff,...
        ...
        % Bondi-Hoyle-Lyttleton drag as a function of current position
        ...
        function accel = getBHLdrag(obj,pos,vel,star,omega,macc,iDRAGCOEF,USE_BHLRAD,iwrite)
            ...
            if companionRad >= star.stellarRadius
                ...
                signdrag = sign( sum( vcon .* vel ) ); % > 0 for a drag     
            end
            accel = [Fx, Fy];
...
%                 obj.err = 1;
    ...
    methods (Static)
        %------------------------------------------------------------------
        % Returns gravitational acceleration (ax, ay) given a
